...
class ResultHelper{
	...
	public static function ResultQuestionP00($playId){
		...
		$sql = "
       		SELECT q0.`id` AS `question_id` ,q0.`question`, r0.`answer` , r0.`id` AS `result_id` ,r0.`correct` , q0.`difficulty`, IFNULL(s.`subject_code`, 0) AS `subject_code` , s.`name` ,s.`description`
				...
				LEFT JOIN `t0130_game_subject` s ON(qs.`subject_id` = s.`id`  )
	...
	public static function ResultQuestionP03($playId){
		$answers = [];
		 ...
		 $sql = "
       		SELECT q3.`id` AS `question_id` ,q3.`question`, r3.`answer_text` , r3.`id` AS `result_id` ,r3.`correct` , q3.`difficulty`, IFNULL(s.`subject_code`, 0) AS `subject_code` , s.`name` ,s.`description`
	...
	public static function ResultQuestionP07($playId){
		$answers = [];
		 ...
		 $sql = "
       		SELECT q7.`id` AS `question_id` ,q7.`left_question_1` , q7.`left_question_2` , q7.`left_question_3` , q7.`right_question_1` , q7.`right_question_2` , q7.`right_question_3` , r7.`answer` , r7.`id` AS `result_id` ,r7.`correct` , q7.`difficulty`, IFNULL(s.`subject_code`, 0) AS `subject_code` , s.`name` ,s.`description`
	...
	public static function ResultQuestionP09($playId){
		$answers = [];
		 ...
		 $sql = "
       		SELECT q9.`id` AS `question_id` , r9.`answer` , r9.`id` AS `result_id` ,r9.`correct` , q9.`difficulty`, IFNULL(s.`subject_code`, 0) AS `subject_code` , s.`name` ,s.`description`
       			FROM (`t0300_game_result` r , `t0209_game_question_p09` q9 , `t0309_game_result_p09` r9)
	...
	public static function ResultQuestionP10($playId){
		$answers = [];
		 ...
		 $sql = "
       		SELECT q10.`id` AS `question_id` , q10.`question` , r10.`answer` , r10.`id` AS `result_id` ,r10.`correct` , q10.`difficulty`, IFNULL(s.`subject_code`, 0) AS `subject_code` , s.`name` ,s.`description`
	...
	public static function ResultQuestionP18($playId){
		$answers = [];
		 ...
		 $sql = "
       		SELECT q18.`id` AS `question_id` , q18.`question` , r18.`answer` , r18.`id` AS `result_id` ,r18.`correct` , q18.`difficulty`, IFNULL(s.`subject_code`, 0) AS `subject_code` , s.`name` ,s.`description`
	...
	public static function ResultQuestionP23($playId){
		$answers = [];
		 ...
		 $sql = "
       		SELECT q23.`id` AS `question_id` ,q23.`question`, r23.`answer` , r23.`id` AS `result_id` ,r23.`correct` , q23.`difficulty`, IFNULL(s.`subject_code`, 0) AS `subject_code` , s.`name` ,s.`description`
	...
	public static function ResultQuestionP32($playId){
		$answers = [];
		 ...
		 $sql = "
       		SELECT q32.`id` AS `question_id` ,q32.`question`, r32.`answer_x`, r32.`answer_y` , r32.`id` AS `result_id` ,r32.`correct` , q32.`difficulty`, IFNULL(s.`subject_code`, 0) AS `subject_code` , s.`name` ,s.`description`
