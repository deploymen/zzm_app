...
require __DIR__.'/Routes/2.0/api.php';
require __DIR__.'/Routes/2.0/api-admin.php';
require __DIR__.'/Routes/2.0/api-user.php';
require __DIR__.'/Routes/2.0/api-game.php';
