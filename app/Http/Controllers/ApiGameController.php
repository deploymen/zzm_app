...
Class ApiGameController extends Controller {
    ...
    public function resultV1_0($planetId) {
        ...
        try {
            ...
            switch ($gameStatus) {
                case 'false': $gameStatus = 'fail';
                    break;
                case 'true': $gameStatus = 'pass';
                    break;
            }
        ...
        try {
            ...
            for ($i = 0; $i <= (count($results) - 1); $i++) {
                ...
                switch ($result[0]->name) {
                    case 'p00': $status = ZapZapQuestionHelper::SubmitResultP00($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p01': $status = ZapZapQuestionHelper::SubmitResultP01($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p02': $status = ZapZapQuestionHelper::SubmitResultP02($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p03': $status = ZapZapQuestionHelper::SubmitResultP03($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p06': $status = ZapZapQuestionHelper::SubmitResultP06($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p07': $status = ZapZapQuestionHelper::SubmitResultP07($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p08': $status = ZapZapQuestionHelper::SubmitResultP08($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p09': $status = ZapZapQuestionHelper::SubmitResultP09($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p10': $status = ZapZapQuestionHelper::SubmitResultP10($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p11': $status = ZapZapQuestionHelper::SubmitResultP11($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p12': $status = ZapZapQuestionHelper::SubmitResultP12($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p13': $status = ZapZapQuestionHelper::SubmitResultP13($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p14': $status = ZapZapQuestionHelper::SubmitResultP14($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p15': $status = ZapZapQuestionHelper::SubmitResultP15($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p16': $status = ZapZapQuestionHelper::SubmitResultP16($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p17': $status = ZapZapQuestionHelper::SubmitResultP17($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p18': $status = ZapZapQuestionHelper::SubmitResultP18($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p19': $status = ZapZapQuestionHelper::SubmitResultP19($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p20': $status = ZapZapQuestionHelper::SubmitResultP20($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p21': $status = ZapZapQuestionHelper::SubmitResultP21($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p23': $status = ZapZapQuestionHelper::SubmitResultP23($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
                    case 'p32': $status = ZapZapQuestionHelper::SubmitResultP32($planetId, $gamePlay, $sgameResult, $profileId);
                        break;
