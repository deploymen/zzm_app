...
class BraintreeController extends Controller {
    ...
    public function braintreeSubscribe(Request $request) {
        ...
        switch ($request->role) {
            case 'parent' : $target = GameProfile::find($request->target_id);
                break;
            case 'teacher' : $target = GameClass::find($request->target_id);
                break;
        ...
        switch ($request->plan_id) {
            case 'class-yearly-199' : $packageId = 'class-yearly-199';
                break;
            case 'class-yearly-99' : $packageId = 'class-yearly-99';
                break;
            case 'profile-yearly-4_99' : $packageId = 'profile-yearly-4.99';
                break;
            case 'profile-yearly-9_99' : $packageId = 'profile-yearly-9.99';
                break;
            default : return ResponseHelper::OutputJSON('fail', 'invalid plan id');
                break;
        }
