...
class AbstractGameResult extends Eloquent {
	...
	private static function SubmitResultFromChild($typeName, $params){
		...
		switch ($typeName) {
			...
			case 'p50':return GameResultP50::SubmitResult($params); break;
			case 'p51':return GameResultP51::SubmitResult($params); break;
			case 'p52':return GameResultP52::SubmitResult($params); break;
			case 'p53':return GameResultP53::SubmitResult($params); break;
			case 'p54':return GameResultP54::SubmitResult($params); break;
			case 'p55':return GameResultP55::SubmitResult($params); break;
			case 'p56':return GameResultP56::SubmitResult($params); break;
			case 'p57':return GameResultP57::SubmitResult($params); break;
			case 'p58':return GameResultP58::SubmitResult($params); break;
            case 'p60':return GameResultP60::SubmitResult($params); break;
			default:break;
		}
	}
