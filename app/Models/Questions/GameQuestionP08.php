...
class GameQuestionP08 extends Eloquent {
	...
	public static function GetQuestions($params){
		...
		$sql = "
			SELECT p08.*, qc.`question_id`, obj.`question_object_1`,obj.`question_object_2`, obj.`question_type`
				FROM (`t0208_game_question_p08` p08, `t0126_game_planet_question_cache` qc)
					LEFT JOIN `t0208_game_question_p08_object` obj ON (obj.`question_id` = p08.`id` )
