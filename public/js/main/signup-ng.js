...
App.controller('MainController', function($scope, $http) {
    ...
    $scope.signUp = function() {
        ...
        var name = angular.element("input.name").val(),
            ...
            role = angular.element(".signup-form input[name=role]:checked").val(),
            country = $scope.country.name,
            password = angular.element("input.password").val();

        if (name == '' || email == ''|| role == '' || country == ''|| password == '') {
            console.log('You have to fill up all fields to complete the sign up');
            return;
        }    
        ...
        if(password.length < 6){
            console.log('password have to be at least 6 characters.');    
            return;
        }        
