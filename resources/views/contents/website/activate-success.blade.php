...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <head>
        ...
        <title>Zap Zap Math | Account Successfully Activated</title>
    ...
    <div class="site-wrapper activate-success sign-in-up">
      <div class="row">
        <section id="signup-holder" class="signup-holder cf">
            <section class="signup-holder-inner small-12 medium-4 medium-centered columns">
                ...
                <a href="/user/signin" class="medium radius button expand blue">Go to sign in</a>
