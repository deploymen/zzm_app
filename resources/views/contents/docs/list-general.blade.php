...
<table class="table table-bordered table-striped table-condensed cf">
    ...
    <tbody>
        <tr>
            <td>1.</td>
            <td>POST</td>
            <td>/api/1.0/auth/sign-up <span class="label alert">hot</span></td>
        ...
        <tr>
            <td>2.</td>
            <td>POST</td>
            <td>/api/1.0/auth/sign-in <span class="label alert">hot</span></td>
        ...
        <tr>
            <td>5.</td>
            <td>GET</td>
            <td>/api/1.0/auth/activate/{secret_key} <span class="label">system use</span> </td>
        ...
        <tr>
            <td>6.</td>
            <td>PUT</td>
            <td>/api/1.0/auth/forgot-password <span class="label alert">hot</span></td>
        ...
        <tr>
            <td>7.</td>
            <td>PUT</td>
            <td>/api/1.0/auth/reset-password <span class="label alert">hot</span></td>
