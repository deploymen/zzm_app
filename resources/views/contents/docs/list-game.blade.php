        ...
        <table class="table table-bordered table-striped table-condensed cf">
            ...
            <tbody>
                <tr>
                    <td>1.</td>
                    <td>POST</td>
                    <td>/api/game/map/system</td>
                    <td>
                    </td>
                    <td align="center"><a href="/docs/api.game-map-system-post" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr>
                <tr>
                    <td>2.</td>
                    <td>POST</td>
                    <td>/api/game/map/system/{id}/planets</td>
                    <td></td>
                    <td align="center"><a href="/docs/api.game-map-system-worksheets-post" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr>
                <tr>
                    <td>3.</td>
                    <td>GET</td>
                    ...
                    <td align="center"><a href="/docs/api.game-profile-nick-get" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr>
                  <tr>
                    <td>4.</td>
                    <td>POST</td>
                    ...
                    <td></td>
                    <td align="center"><a href="/docs/api.game-profile-verify-post" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr> 
                 <tr>
                    <td>5.</td>
                    <td>GET</td>
                    <td>/api/game/user-map</td>
                    <td></td>
                    <td align="center"><a href="/docs/api.game-user-map-get" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr> 
                <!--  <tr>
                    <td>6.</td>
                    <td>GET</td>
                    <td>/api/game/leaderboard/world</td>
                    <td></td>
                    <td align="center"><a href="/docs/api.game-leaderboard-world-get" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr> 
                 <tr>
                    <td>7.</td>
                    <td>GET</td>
                    <td>/api/game/leaderboard/system/{system_id}</td>
                    <td></td>
                    <td align="center"><a href="/docs/api.game-leaderboard-system-get" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr>  -->
                 <tr>
                    <td>6.</td>
                    <td>GET</td>
                    <td>/api/game/leaderboard/planet/{planet_id}</td>
                    <td></td>
                    <td align="center"><a href="/docs/api.game-leaderboard-planet-get" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr> 
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-striped table-condensed cf">
            ...
            <tbody>
                <tr>
                    <td>1.</td>
                    <td>POST</td>
                    <td>/api/game/play/150/result </td>
                    <td>p01</td>
                    <td align="center"><a href="/docs/api.game-play-result-post-p01" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr>
                <tr>
                    <td>2.</td>
                    <td>POST</td>
                    <td>/api/game/play/103/result </td>
                    <td>p02</td>
                    <td align="center"><a href="/docs/api.game-play-result-post-p02" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr>
                        <tr>
                    <td>3.</td>
                    <td>POST</td>
                    <td>/api/game/play/166/result </td>
                    <td>p03</td>
                    <td align="center"><a href="/docs/api.game-play-result-post-p03" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr>
              
                <tr>
                    <td>5.</td>
                    <td>POST</td>
                    <td>/api/game/play/155/result </td>
                    <td>p06</td>
                    <td align="center"><a href="/docs/api.game-play-result-post-p06" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr>
                <tr>
                    <td>6.</td>
                    <td>POST</td>
                    <td>/api/game/play/114/result </td>
                    <td>p07</td>
        ...
        <table class="table table-bordered table-striped table-condensed cf">
            ...
            <tbody>
                <tr>
                    <td>1.</td>
                    <td>GET</td>
                    <td>/api/game/result/system-planet/progress</td>
                    <td></td>
                    <td align="center"><a href="/docs/api.game-result-progress-get" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                    </tr> 
                    <tr>
                    <td>2.</td>
                    <td>GET</td>
                    <td>/api/game/result/system-planet/play/planet/{planet_id}</td>
                    <td></td>
                    <td align="center"><a href="/docs/api.game-result-play-get" target="_blank"><i class="fa fa-chevron-circle-right" style="font-size: 20px;"></i></a></td>
                </tr>
            </tbody>
        </table>
