    ...
    <body>
        ...
        <div class="contributor-wrapper">
            <header class="contributor-banner">
                ...
                <div class="row cf">
                    <div class="badge-box">
                        <img src="assets/img/contributors/contributor-badge.png" alt="">
                    </div>
                    <div class="text-box">
                        <h2>Contributors Page</h2>
                        <p>
                            The following people have and continue to contribute their time &amp; expertise to help make Zap Zap Math the best math platform in the world
                        </p>
                    </div>
                </div>
            </header>
